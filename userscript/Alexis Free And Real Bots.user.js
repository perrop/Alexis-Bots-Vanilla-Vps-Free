// ==UserScript==
// @name         Alexis Free And Real Bots
// @namespace    Alexis Free And Real Bots + Potion
// @version      2.0.1
// @description  Alexis 200 bots Free
...
document.getElementById('advertisement').innerHTML =`<center><iframe width="300" height="250" src="Alexis 200 bots" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></center>`
...
document.getElementById('mcbanners').innerHTML = `
    <div class="agario-panel" style="border-top: 5px solid #09f4ff; background-image: url("http://cdn.ogario.ovh/static/img/pattern.png"); background-repeat: repeat; background-position: top center; position:absolute;margin-top: 4px; width: 330px; height: 500; background-color: #fff;">
    	<center><h3 id="wikwik">[AA]Alexis_X
#5882</h3></center>
    <div class="agario-panel" style="border-top: 5px solid #09f4ff; background-image: url("http://cdn.ogario.ovh/static/img/pattern.png"); background-repeat: repeat; background-position: top center; position:absolute;margin-top: 4px; width: 330px; height: 500; background-color: #fff;">
    <br>
    <head>
...
function setGUIEvents() {
    ...
    document.getElementById('gbutton').addEventListener('click', () => {
	    window.open("https://discord.gg/NyNQfJE", '_self');
